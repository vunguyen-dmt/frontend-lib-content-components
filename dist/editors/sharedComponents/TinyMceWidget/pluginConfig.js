...
const pluginConfig = _ref => {
  ...
  return (0, _utils.StrictDict)({
    ...
    menubar: false,
    toolbar: toolbar ? mapToolbars([[_tinyMCE.buttons.undo, _tinyMCE.buttons.redo, _tinyMCE.buttons.formatpainter], [_tinyMCE.buttons.formatSelect], [_tinyMCE.buttons.fontselect], [_tinyMCE.buttons.fontsizeselect], [labelButton], [_tinyMCE.buttons.bold, _tinyMCE.buttons.italic, _tinyMCE.buttons.underline, _tinyMCE.buttons.foreColor, _tinyMCE.buttons.backColor], [_tinyMCE.buttons.align.left, _tinyMCE.buttons.align.center, _tinyMCE.buttons.align.right, _tinyMCE.buttons.align.justify], [_tinyMCE.buttons.bullist, _tinyMCE.buttons.numlist, _tinyMCE.buttons.outdent, _tinyMCE.buttons.indent], [_tinyMCE.buttons.image, _tinyMCE.buttons.link, _tinyMCE.buttons.unlink, _tinyMCE.buttons.blockQuote, _tinyMCE.buttons.codeBlock], [_tinyMCE.buttons.table, _tinyMCE.buttons.emoticons, _tinyMCE.buttons.charmap, _tinyMCE.buttons.hr], [_tinyMCE.buttons.removeFormat, codeButton]]) : false,
    // imageToolbar: mapToolbars([
    //   // [buttons.rotate.left, buttons.rotate.right],
    //   // [buttons.flip.horiz, buttons.flip.vert],
    //   [editImageSettings],
    // ]),
    quickbarsInsertToolbar: toolbar ? false : mapToolbars([[_tinyMCE.buttons.undo, _tinyMCE.buttons.redo], [_tinyMCE.buttons.formatSelect], [_tinyMCE.buttons.fontselect], [_tinyMCE.buttons.fontsizeselect], [_tinyMCE.buttons.bold, _tinyMCE.buttons.italic, _tinyMCE.buttons.underline, _tinyMCE.buttons.foreColor], [_tinyMCE.buttons.align.justify, _tinyMCE.buttons.bullist, _tinyMCE.buttons.numlist], [_tinyMCE.buttons.image, _tinyMCE.buttons.blockQuote, _tinyMCE.buttons.codeBlock], [_tinyMCE.buttons.table, _tinyMCE.buttons.emoticons, _tinyMCE.buttons.charmap, _tinyMCE.buttons.removeFormat]]),
