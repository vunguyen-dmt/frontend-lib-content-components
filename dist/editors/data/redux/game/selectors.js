...
exports.simpleSelectors = exports.gameState = exports.default = void 0;
...
const mkSimpleSelector = cb => (0, _reselect.createSelector)([_module.gameState], cb);
...
var _default = _objectSpread({}, simpleSelectors);
