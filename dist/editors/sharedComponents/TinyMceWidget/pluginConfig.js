...
const pluginConfig = _ref => {
  ...
  return (0, _utils.StrictDict)({
    ...
    //   [editImageSettings],
    // ]),
    quickbarsInsertToolbar: toolbar ? false : mapToolbars([[_tinyMCE.buttons.undo, _tinyMCE.buttons.redo], [_tinyMCE.buttons.formatSelect], [_tinyMCE.buttons.fontselect], [_tinyMCE.buttons.fontsizeselect], [_tinyMCE.buttons.bold, _tinyMCE.buttons.italic, _tinyMCE.buttons.underline, _tinyMCE.buttons.foreColor], [_tinyMCE.buttons.align.justify, _tinyMCE.buttons.bullist, _tinyMCE.buttons.numlist], [_tinyMCE.buttons.media, _tinyMCE.buttons.blockQuote, _tinyMCE.buttons.codeBlock], [_tinyMCE.buttons.table, _tinyMCE.buttons.emoticons, _tinyMCE.buttons.charmap, _tinyMCE.buttons.wirisMathType, _tinyMCE.buttons.wirisChemType, _tinyMCE.buttons.removeFormat]]),
