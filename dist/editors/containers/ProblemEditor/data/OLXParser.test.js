  ...
  describe('parseQuestions()', () => {
    ...
    describe('given olx with html entities', () => {
      ...
      it('should not encode html entities', () => {
        expect(question).toEqual(_olxTestData.htmlEntityTestOLX.question);
      });
    });
  ...
  describe('getSolutionExplanation()', () => {
    describe('for checkbox questions', () => {
      test('should parse text in p tags', () => {
        const {
          rawOLX
        } = (0, _olxTestData.getCheckboxesOLXWithFeedbackAndHintsOLX)();
        const olxparser = new _OLXParser.OLXParser(rawOLX);
        const problemType = olxparser.getProblemType();
        const explanation = olxparser.getSolutionExplanation(problemType);
        const expected = (0, _olxTestData.getCheckboxesOLXWithFeedbackAndHintsOLX)().solutionExplanation;
