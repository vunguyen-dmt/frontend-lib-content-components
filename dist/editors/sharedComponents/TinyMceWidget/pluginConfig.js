...
const pluginConfig = _ref => {
  ...
  return (0, _utils.StrictDict)({
    plugins: [_tinyMCE.plugins.link, _tinyMCE.plugins.lists, _tinyMCE.plugins.codesample, _tinyMCE.plugins.emoticons, _tinyMCE.plugins.table, _tinyMCE.plugins.hr, _tinyMCE.plugins.charmap, codePlugin, _tinyMCE.plugins.autoresize, image, imageTools, quickToolbar, _tinyMCE.plugins.a11ychecker, _tinyMCE.plugins.powerpaste, _tinyMCE.plugins.embediframe, _tinyMCE.plugins.media].join(' '),
    menubar: false,
    toolbar: toolbar ? mapToolbars([[_tinyMCE.buttons.undo, _tinyMCE.buttons.redo], [_tinyMCE.buttons.formatSelect], [_tinyMCE.buttons.fontselect], [_tinyMCE.buttons.fontsizeselect], [labelButton], [_tinyMCE.buttons.bold, _tinyMCE.buttons.italic, _tinyMCE.buttons.underline, _tinyMCE.buttons.strikethrough, _tinyMCE.buttons.foreColor, _tinyMCE.buttons.backColor], [_tinyMCE.buttons.align.left, _tinyMCE.buttons.align.center, _tinyMCE.buttons.align.right, _tinyMCE.buttons.align.justify], [_tinyMCE.buttons.bullist, _tinyMCE.buttons.numlist, _tinyMCE.buttons.outdent, _tinyMCE.buttons.indent], [_tinyMCE.buttons.image, _tinyMCE.buttons.media, _tinyMCE.buttons.link, _tinyMCE.buttons.unlink, _tinyMCE.buttons.blockQuote, _tinyMCE.buttons.codeBlock], [_tinyMCE.buttons.table, _tinyMCE.buttons.emoticons, _tinyMCE.buttons.charmap, _tinyMCE.buttons.wirisMathType, _tinyMCE.buttons.wirisChemType, _tinyMCE.buttons.hr], [_tinyMCE.buttons.removeFormat, codeButton, _tinyMCE.buttons.a11ycheck, _tinyMCE.buttons.embediframe]]) : false,
    ...
    // ]),
    imageToolbar: false,
    quickbarsInsertToolbar: toolbar ? false : mapToolbars([[_tinyMCE.buttons.undo, _tinyMCE.buttons.redo], [_tinyMCE.buttons.formatSelect], [_tinyMCE.buttons.fontselect], [_tinyMCE.buttons.fontsizeselect], [_tinyMCE.buttons.bold, _tinyMCE.buttons.italic, _tinyMCE.buttons.underline, _tinyMCE.buttons.foreColor], [_tinyMCE.buttons.align.justify, _tinyMCE.buttons.bullist, _tinyMCE.buttons.numlist], [_tinyMCE.buttons.image, _tinyMCE.buttons.media, _tinyMCE.buttons.blockQuote, _tinyMCE.buttons.codeBlock], [_tinyMCE.buttons.table, _tinyMCE.buttons.emoticons, _tinyMCE.buttons.charmap, _tinyMCE.buttons.wirisMathType, _tinyMCE.buttons.wirisChemType, _tinyMCE.buttons.removeFormat, _tinyMCE.buttons.a11ycheck]]),
