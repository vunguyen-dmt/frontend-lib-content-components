...
const openLanguages = (0, _reselect.createSelector)([_module.simpleSelectors.transcripts], transcripts => {
  if (!transcripts) {
...
exports.openLanguages = openLanguages;
const getTranscriptDownloadUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl, AppSelectors.simpleSelectors.blockId], (studioEndpointUrl, blockId) => _ref => {
  let {
    language
  } = _ref;
...
exports.getTranscriptDownloadUrl = getTranscriptDownloadUrl;
const buildTranscriptUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl], studioEndpointUrl => _ref2 => {
  let {
    transcriptUrl
  } = _ref2;
...
exports.buildTranscriptUrl = buildTranscriptUrl;
const getHandoutDownloadUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl], studioEndpointUrl => _ref3 => {
  let {
    handout
  } = _ref3;
...
var _default = _objectSpread(_objectSpread({}, simpleSelectors), {}, {
  openLanguages,
